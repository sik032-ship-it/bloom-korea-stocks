...
const crisisQuestions: QuizQuestion[] = [
  ...
  { format: "ox", difficulty: "intermediate", category: "crisis", statement: "2008년 금융위기 때 S&P 500은 1년 안에 위기 전 최고치를 회복했다", answer: false, explanation: "S&P 500은 2007년 10월 고점에서 2009년 3월까지 약 57% 떨어졌고, 가격 기준으로 고점을 되찾은 건 2013년 3월이에요. 약 5년 반이 걸렸죠. 그래도 버틴 사람은 결국 회복을 경험했어요.", insight: "역사는 '버틴 사람이 이긴다'는 것을 반복적으로 증명하고 있어요." },
  ...
  { format: "fill_blank", difficulty: "advanced", category: "crisis", sentence: "위기 때 폭락한 우량주를 살 수 있게 해주는 것은 미리 준비해 둔 ___이다", answer: "현금", hints: ["현금", "유동성"], explanation: "현금이 있어야 위기 때 폭락한 우량주를 살 수 있어요. 현금은 기회의 무기예요.", insight: "현금은 '아무것도 안 하는 것'이 아니라 '기회를 기다리는 것'이에요." },
...
const legendWisdomQuestions: QuizQuestion[] = [
  // beginner
  { format: "ox", difficulty: "beginner", category: "legend_wisdom", statement: "워런 버핏은 10년 보유할 생각이 없다면 10분도 보유할 생각을 하지 말라고 했다", answer: true, explanation: "버핏이 1996년 주주서한에 쓴 말이에요. 그는 '우리가 가장 좋아하는 보유 기간은 영원이다'라는 말도 남겼어요.", insight: "이 한 문장만 깊이 새겨도 단타 충동을 90% 줄일 수 있어요." },
  ...
  { format: "ox", difficulty: "intermediate", category: "legend_wisdom", statement: "우량주라면 큰 폭락 후에도 언제나 5년 안에 최고가를 회복한다", answer: false, explanation: "애플·아마존(2008), 메타(2022)는 몇 년 안에 회복했어요. 하지만 마이크로소프트는 1999년 고점을 되찾는 데 2016년까지 약 16년이 걸렸어요. 비싸게 샀다면 좋은 기업도 오래 기다려야 해요.", insight: "팔아버린 사람들은 '3배 오르는 것'을 그저 뉴스로만 봐야 했어요. 매일의 멘탈 훈련이 그 차이를 만들어요." },
];
