...
// 오늘 가격 기준일: 2026-09-24 (Yahoo Finance 종가)
...
export const LEGENDARY_BARGAINS: LegendaryBargain[] = [
  ...
  },
  {
    ...
    todayPriceLabel: "약 $337",
    multiplier: 13.5,
    story: "버핏은 평생 '기술주는 모른다'며 피했지만 2016년 1분기에 처음 매수했어요. 평균 매수가는 분할 전 약 $99.49 (당시 주가 범위 기준 추정), 2020년 4:1 분할로 환산하면 약 $24.87입니다. 이유는 단순했어요 — '내 가족과 친구 모두가 아이폰을 쓴다.'",
  ...
  },
  {
    ...
    investorEmoji: "👓",
    buyYear: 1980,
    buyPriceLabel: "약 $0.13/주 (분할조정)",
    todayPriceLabel: "약 $110",
    multiplier: 850,
    story: "1980년 월마트는 미국 시골 지역에만 있는 작은 할인점이었어요. 월스트리트는 무시했지만 린치는 '아직 미국 절반에 진출도 안 했다'며 주목했습니다. 1980년 이후 8번의 주식 분할(2024년 3:1 포함)을 거치며 그때의 1주는 오늘 384주가 되었고, 가치는 약 850배가 되었어요.",
  ...
  },
  {
    ...
    investorEmoji: "🎩",
    buyYear: 1964,
    buyPriceLabel: "당시 주당 약 $35 (분할조정 약 $3)",
    todayPriceLabel: "약 $300",
    multiplier: 100,
    story: "1963년 '샐러드 오일 스캔들'로 아멕스 주가는 약 $60에서 $35까지, 40% 넘게 폭락했어요. 모두가 '망했다'고 했지만 버핏은 식당과 호텔에서 사람들이 여전히 아멕스 카드로 결제하는 걸 직접 확인했어요. 그래서 버핏 파트너십 자산의 약 40%를 베팅했습니다.",
  ...
  },
  {
    ...
    todayPriceLabel: "약 $238",
    multiplier: 160,
    story: "린치는 '맥도날드는 부동산 회사'라고 했어요. 어디서나 똑같은 햄버거, 어디서나 똑같은 매장 — 이 단순함이 40년 넘게 약 160배의 수익을 만들었습니다.",
  ...
  },
  {
    ...
    todayPriceLabel: "약 $500",
    multiplier: 37,
    story: "2009년 3월, 금융위기 한복판에서 MSFT는 약 $13.46까지 떨어졌어요. '한물갔다'는 평가를 받았지만, 클라우드(Azure) 시대를 이끌며 약 17년 만에 약 37배가 되었습니다. 위기는 1등 기업을 떨이로 살 기회였어요.",
