        ...
        <>
          <div className="grid grid-cols-2 gap-2 mt-4">
            <div className="rounded-xl bg-tone-caution-bg p-3">
              <RotateCcw className="w-4 h-4 text-tone-caution-fg" />
            ...
            <div className="rounded-xl bg-tone-growth-bg p-3">
              <Trophy className="w-4 h-4 text-tone-growth-fg" />
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex justify-between text-small">
                        ...
                        <span className="text-muted-foreground flex items-center gap-1">
                          {improving && <TrendingUp className="w-3.5 h-3.5 text-tone-growth-fg" />}
                          {pct}% · {w.attempts}문제
                        </span>
                      </div>
                      <div className="h-2 rounded-full bg-muted mt-1 overflow-hidden">
                        <div className="h-full bg-tone-caution-fg rounded-full" style={{ width: `${pct}%` }} />
                      </div>
                    </div>
                  </div>
                );
          ...
          {profile.strongest && (
            <p className="text-xs text-muted-foreground mt-3">
              나의 무기: <span className="font-bold text-tone-growth-fg">{categoryLabels[profile.strongest.category].name}</span>
            </p>
          )}
